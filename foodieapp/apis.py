...
from foodieapp.models import Restaurant, Meal, Order, OrderDetails
from foodieapp.serializers import RestaurantSerializer, MealSerializer, OrderSerializer

import stripe
from foodie.settings import STRIPE_API_KEY
